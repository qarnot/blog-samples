...
PROFILE="openfoam-foundation"                        

NB_INSTANCES = 2                               # Number of instances in your cluster.

PATH_TO_DIR = '/home/chloe.pilon/Documents/BENCH/Openfoam/MOTORBIKE-11'     # Path to your model's directory
DIR_TO_SYNC = 'MOTORBIKE-11'                    # Name for your model's directory
INPUT_BUCKET_NAME =  f"{DIR_TO_SYNC}-in"    
OUTPUT_BUCKET_NAME = f"{DIR_TO_SYNC}-out"
TASK_NAME = f"RUN test OpenfoamFoundation - {DIR_TO_SYNC}" 

OPENFOAMF_CMD = "Allrun"          
# =============================== TASK CONFIGURATION =============================== #
...
task.constants['OPENFOAM_INPUT_DIRECTORY_NAME'] = f"{DIR_TO_SYNC}-in"

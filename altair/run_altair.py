...
ALTAIR_EXTRA_PARAMS = "TO_BE_DEFINED"          # Optional : Extra parameters to your ALTAIR_CMD, such as : mpi, etc. 
IMPI_ARGS = ""                                 # Optional : Use for additional IMPI Args. Enter only IMPI args, they will be added with -mpiargs
